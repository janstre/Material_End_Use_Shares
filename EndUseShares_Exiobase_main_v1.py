...
from EndUseShares_functions_v5 import hypothetical_transfer_exio, create_WIOMassFilter_plain, match_multiIndex,\
...
# loop over years to conduct hypothetical transfer, afterwards loop over regions to calculate D_WIO per region and year                                                                                
for year in years:
    ...
    for region in regions:
        ...
        # with A_ht (= region-specific technology matrix)
        ...
        del Y_region, D_ht_wio_region, D_ht_wio_region_aggregated, HTWIO_split_region, check_wio_ht_region, fileName_HTWIOMF
            
    del exio3, Y_full, Y_full_dom, Y_full_regions, A_full, I, L_full, x, x_diag, Z_full, yield_filter, filter_transf,\
        filt_Amp_label, filt_App_label, Y_transferred, Z_transferred, A_ht
